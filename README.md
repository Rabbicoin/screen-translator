...
работать во всех остальных программах; и `Esc` назначить нельзя — ею закрывается
окно перевода. Клавиша запоминается по коду, а не по букве, поэтому на русской
